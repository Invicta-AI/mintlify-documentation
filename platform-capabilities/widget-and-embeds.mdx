...
icon: comment
---
The Widget and Embed feature allows you to integrate your Invicta AI agent into a chat widget or an embed window on your website. This enables users to interact with your agent directly on your site, without the need for sign-up, providing a seamless experience similar to the ChatUI on the Invicta AI platform.
...
<Card
  ...
  icon="book"
  href="/content/how-to/widget-setup"
>
  For detailed instructions on setting up your widget, refer to our
  comprehensive guide.
</Card>
...
<Note>
  **Key differences in widget/embed functionality:** <br /><br /> 1. **Steps** like "Knowledge
  Base retrieved", tool uses, or AI teammate invocations are not displayed.
  <br /><br /> 2. **Compute Points** for agent usage within the widget are deducted from
  the agent's author, not the end-user.
</Note>
