...
## **New LLMs: Claude 4 Series**
Added Anthropic's latest flagship models:

- Claude 4 Sonnet - Enhanced performance and reasoning capabilities
- Claude 4 Opus - Most advanced reasoning model with superior problem-solving abilities

</Update>

<Update label="April 17, 2025">
## **New LLM: Gemini Flash 2.5**
Added Google's latest Flash model, delivering efficient and lightning-fast responses for high-throughput applications.

</Update>

<Update label="April 16, 2025">
## **New LLM: OpenAI o3**
Added OpenAI's latest general availability model, now available for all users.

</Update>

<Update label="April 14, 2025">
## **New LLM: GPT 4.1**
Added OpenAI's newest GPT model, featuring enhanced reasoning capabilities and improved performance across all task types.

</Update>

<Update label="March 25, 2025">
## **New LLM: Gemini Pro 2.5**
Added Google's latest Pro model. Features include:
...
<Update label="March 23, 2025">
## **Knowledge Base Foldering and Management**

Major update to the Knowledge Base system:

- Introduced folder organization with agent-specific enable/disable controls
- Significantly improved loading performance for agent chat interface and knowledge base
- Added bulk operations for knowledge base entries:
  - Mass move functionality
  - Batch deletion
  - Bulk enable/disable for agents
...
Enhanced agent creation experience with new startup options:

- Template-based agent creation
- Start from scratch option
- Integrated tutorial video guidance for the Agent Builder
...
<Update label="March 13, 2025">
  ## **New LLM: GPT-4.5**
   ...
   - Added OpenAI's latest non-reasoning LLM.
...
<Update label="March 12, 2025">
  ## **Landing Page Update**
   ...
   - Refreshed landing page with improved user
  experience and updated content.

</Update>

<Update label="March 7, 2025">
## **Pipedrive CRM Integration**
Added 21 new agentic tools for Pipedrive CRM.

## **Builder Interface Segmentation**

Reorganized the Builder interface into three distinct sections:

- **Core**: Essential components including system message, tools, and triggers
- **Cosmetic**: Visual and non-functional customization options
- **Advanced**: Power user features like variables and preferred LLM settings

</Update>

<Update label="March 2, 2025">
## **Notification Improvements**
- Disabled email notifications for batch mode operations with Human in the Loop tools

## **LLM Selection Enhancement**

- LLM selector now properly affects request regeneration

## **Bug Fixes**

- Resolved Human in the Loop functionality issues
- Fixed the Agent Builder agent related bugs

</Update>

<Update label="February 26, 2025">
## **New LLM: Claude 3.7 Sonnet**
- Added Anthropic's latest hybrid reasoning model.
- Now designated as our "Smartest" category model.

</Update>

<Update label="February 25, 2025">
## **Apollo Integration**
Added Apollo company enrichment tool. Agents can now:
- Look up company data (revenue, employee count, etc.)
- Access Apollo's business database directly

</Update>

<Update label="February 24, 2025">
## **Batch Mode Monitoring**
- Now, you easily monitor the reasoning process for each row of the batch operation, which gets a separate branch within a thread.

## **Re-generate**

- Easily re-generate any response with a single click
...
- You can now Edit your previous inputs to generate a new response in a new branch.
- If you want to make an edit with a new LLM, simply change it in the LLM selector and save the edits.
...
- You can now view the number of tokens that the current chat had consumed in the Chat UI

## **Bug Fixes**

- Human in the loop triggering for tools where HiLT is not turned on fixed
- LLM selector resetting to preferred LLM after every request
- Mobile compatibility and accessibility fixes
- and more...

</Update>

<Update label="February 2, 2025">
## **New LLMs by DeepSeek**  
Added DeepSeek's newest LLMs:  
- **R1**: (open-source reasoning specialist) + **V3** (enterprise-grade inference)

New OpenAI LLM:

- Introduced ChatGPT-4o-latest (auto-updating to OpenAI latest ChatGPT version)

## **Agent Configuration Limits**

Set maximum configuration parameters:

- 10 tools per agent
- 10 collaborators per agent

</Update>

<Update label="January 27, 2025">
## **Human-in-the-Loop for tools**  
Added tool execution approval controls:  
- Per-tool approval settings in Builder
- Add custom reasons when rejecting actions
- Get notified through email and sidebar indicators
...
- Introduced flexible credit bundles for Pro/Business tiers
- Business plans now include 10 default user seats

</Update>

<Update label="January 8, 2025">
## **Stripe Integration & Tools**  
Added 5 new Stripe tools including:  
- Charge refund management  
- Subscription lifecycle controls  
- Customer/subscription search capabilities

## **Bye Compute Points!**

Renamed "compute points" to "credits" across all platform interfaces.

## **Free Tier Enhancement**

Increased Knowledge Base entry limit from 5 to 50 entries for free accounts.
