...
## New Features
- Introduced a data analysis tool to analyze and visualize user data.
- Added Google Sheets integration to manage and edit sheets directly within the platform.

## Enhancements
- Implemented support for variables to facilitate the setup of official or community agents.

## Bug Fixes
- Various bug fixes to improve reliability and performance.
