...
<Update label="Tuesday, December 3, 2024">

## Bio Context Memory
Introduced a bio context memory feature to remember past discussions and enhance future chats.

## Questions Variables in Builder
Added the ability to use question variables in the builder for dynamic changes in system messages, particularly useful for cloning agents.

## Subscription Management
Users can now easily upgrade or downgrade their subscription plans.

## Promocodes
Promocodes can now be used by new users who have never had subscriptions.

## Builder Optimization
The builder has been optimized to reduce lags.
...
- Introduced organization-level Compute points for better resource management.
