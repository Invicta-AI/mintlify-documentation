...
<CardGroup cols={2}>
  <Card title="Database" icon="database" href="/tools/database-tools">
...
| 52  | Stripe Create Refunds                | Create refunds for specific charges                                    |
| 53  | Stripe Delete Subscription           | Remove subscriptions using their ID                                    |
| 54  | Stripe Find Invoices                 | Find invoices associated with subscriptions                            |
| 55  | Stripe Find Subscriptions            | Find subscriptions by customer ID                                      |
| 56  | Stripe Search Customers              | Search for customers using their email                                 |
| 57  | Apollo Company Enrichment            | Search for company details in Apollo database                          |
| 58  | Pipedrive Create Deals               | Creates new deals in Pipedrive                                         |
| 59  | Pipedrive Create Lead Labels         | Creates new lead labels in Pipedrive                                   |
| 60  | Pipedrive Create Leads               | Creates new leads in Pipedrive                                         |
| 61  | Pipedrive Create Notes               | Creates notes for deals, persons, or organizations in Pipedrive        |
| 62  | Pipedrive Create Organizations       | Creates new organizations in Pipedrive                                 |
| 63  | Pipedrive Create Persons             | Creates new persons in Pipedrive                                       |
| 64  | Pipedrive Create Products            | Creates new products in Pipedrive                                      |
| 65  | Pipedrive List Lead Labels           | Lists all available lead labels in Pipedrive                           |
| 66  | Pipedrive List Notes                 | Lists notes based on criteria in Pipedrive                             |
| 67  | Pipedrive Search Deals               | Searches for deals based on criteria in Pipedrive                      |
| 68  | Pipedrive Search Leads               | Searches for leads based on criteria in Pipedrive                      |
| 69  | Pipedrive Search Organizations       | Searches for organizations based on criteria in Pipedrive              |
| 70  | Pipedrive Search Persons             | Searches for persons based on criteria in Pipedrive                    |
| 71  | Pipedrive Search Products            | Searches for products based on criteria in Pipedrive                   |
| 72  | Pipedrive Update Deals               | Updates existing deals in Pipedrive                                    |
| 73  | Pipedrive Update Lead Labels         | Updates existing lead labels in Pipedrive                              |
| 74  | Pipedrive Update Leads               | Updates existing leads in Pipedrive                                    |
| 75  | Pipedrive Update Notes               | Updates existing notes in Pipedrive                                    |
| 76  | Pipedrive Update Organizations       | Updates existing organizations in Pipedrive                            |
| 77  | Pipedrive Update Persons             | Updates existing persons in Pipedrive                                  |
| 78  | Pipedrive Update Products            | Updates existing products in Pipedrive                                 |
...
<Tip>
  ...
  Our team reviews submissions daily, and will respond within 30 minutes on
  workdays.
</Tip>
