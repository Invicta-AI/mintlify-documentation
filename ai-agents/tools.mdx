...
Tools in the Invicta AI platform extend the capabilities of our agents, allowing them to perform a wide variety of tasks and actions efficiently. These tools enable agents to interact with external systems, perform complex operations, and automate workflows, enhancing their utility and effectiveness in various roles.
...
<CardGroup cols={2}>
  <Card title="Data and Web Tools" icon="globe" href="/tools/data-web">
    Empower your agents with advanced web browsing, searching, and data scraping
    capabilities.
  </Card>
  <Card title="Airtable Tools" icon="database" href="/tools/airtable">
  ...
  <Card title="Calendar Tools" icon="calendar" href="/tools/calendar">
    Streamline scheduling and event management across different calendar
    platforms.
  </Card>
  <Card title="HubSpot Tools" icon="briefcase" href="/tools/hubspot">
    Facilitate comprehensive CRM management and customer engagement through
    HubSpot integration.
  </Card>
  <Card title="Email Tools" icon="envelope-open-text" href="/tools/email">
    Enhance communication capabilities with tools for sending and managing
    emails across platforms.
  </Card>
  <Card title="Communication Tools" icon="comments" href="/tools/communication">
    Improve team collaboration with integrated messaging tools like Slack.
  </Card>
</CardGroup>
